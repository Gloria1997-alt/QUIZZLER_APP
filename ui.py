...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.unknown_button = Button(image=self.cross_img, highlightthickness=0, command=self.false_pressed)
        self.unknown_button.grid(row=2, column=0)

        self.check_img = PhotoImage(file="images/true.png")
        self.known_button = Button(image=self.check_img, highlightthickness=0, command=self.true_pressed)
